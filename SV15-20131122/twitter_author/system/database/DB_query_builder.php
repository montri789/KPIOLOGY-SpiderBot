...
abstract class CI_DB_query_builder extends CI_DB_driver {
	...
	public function insert_batch_ignore($table = '', $set = NULL, $escape = NULL)
	{
		if ($set !== NULL)
		{
			$this->set_insert_batch($set, '', $escape);
		...
		for ($i = 0, $total = count($this->qb_set); $i < $total; $i += 100)
		{
                        //echo $this->_insert_batch_ignore($this->protect_identifiers($table, TRUE, $escape, FALSE), $this->qb_keys, array_slice($this->qb_set, $i, 100)); exit;
                    
			$this->query($this->_insert_batch_ignore($this->protect_identifiers($table, TRUE, $escape, FALSE), $this->qb_keys, array_slice($this->qb_set, $i, 100)));
			$affected_rows += $this->affected_rows();
		}
	...
	protected function _insert_batch($table, $keys, $values)
	{
        ...
        protected function _insert_batch_ignore($table, $keys, $values)
	{
