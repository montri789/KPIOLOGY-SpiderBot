...
echo ====== Start Run fetchPantipWeek ====== %date% %time% >> C:\script\log_fetch\fetchPantipWeek.txt
...
echo End Run fetchPantipWeek %date% %time% >> C:\script\log_fetch\fetchPantipWeek.txt
timeout /t 5
