...
class Matcher_auto_id extends CI_Controller{

	public function bot($type='queue',$client_id=null,$to_date=null)
	{
		//$this->clear($client_id);
	
		$query_index = $this->db->get_where('sphinx_index',array('name'=>'203.151.21.111'));
	...
	public function run($subject_id,$clean=true,$query_offset=0,$match_to_id)
	{
