...
class Matcher_gen_sql extends CI_Controller{
...
//					echo '('.$k.')'.$docinfo["id"]." ";
						...
						if($post->type == "post" || $post->type == "comment"){	
							...
							if($postData != null){
								...
								*/
								...
								$sql_filename ="gen_sql_c7/c_id_".$subject->client_id."-s_id_".$subject_id.".sql";
			...
			foreach($q_post_id_from_list_page_id->result_array() as $val){
						...
						$sql_filename ="gen_sql_c7/c_id_".$client_id."-s_id_".$subject_id."-wpc.sql";
